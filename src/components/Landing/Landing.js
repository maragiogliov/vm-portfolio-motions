      ...
      <section className="label-text">
        ...
        <section className="container-globo">
          <svg className="globe" viewBox="0 0 100 100">
            ...
            <ellipse className="wireframe" cx="50" cy="50" rx="48" ry="48" transform="rotate(30 50 50)"></ellipse>
            <ellipse className="wireframe" cx="50" cy="50" rx="48" ry="48" transform="rotate(60 50 50)"></ellipse>
            <ellipse className="wireframe" cx="50" cy="50" rx="48" ry="48" transform="rotate(90 50 50)"></ellipse>
            <ellipse className="wireframe" cx="50" cy="50" rx="48" ry="48" transform="rotate(120 50 50)"></ellipse>
            <ellipse className="wireframe" cx="50" cy="50" rx="48" ry="48" transform="rotate(150 50 50)"></ellipse>
            <ellipse className="wireframe" cx="50" cy="50" rx="48" ry="48" transform="rotate(180 50 50)"></ellipse>
          </svg>
        </section>
      </section>
    </section>
